...
<img src="https://skillicons.dev/icons?i=html,css,js,python,php,java,cpp,react,nodejs,mysql,mongodb,git,github,vscode" />
...
`🌐 Websites`   `💻 Web Apps`   `🚀 SaaS`   `🤖 AI Tools`
`⚙️ Automation`   `📊 Dashboards`   `🛒 E-commerce`   `🎨 UI/UX`
...
**Have an idea or project? Let's build something.**
